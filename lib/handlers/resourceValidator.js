...
class ResourceValidator {
    ...
    getFunctionappSettingsRbac(state, appService) {
        return __awaiter(this, void 0, void 0, function* () {
            utils_1.Logger.Info('getFunctionappSettingsRbac');
            let appSettings;
            try {
    ...
    getFunctionappSettingsScm(state, kuduService) {
        return __awaiter(this, void 0, void 0, function* () {
            utils_1.Logger.Info('getFunctionappSettingsScm');
            let appSettings;
            try {
                utils_1.Logger.Info('getFunctionappSettingsScm.X1');
                appSettings = yield kuduService.getAppSettings();
                utils_1.Logger.Info('getFunctionappSettingsScm.X2');
            }
            catch (expt) {
                utils_1.Logger.Info('getFunctionappSettingsScm.E1');
            ...
            utils_1.Logger.Info('getFunctionappSettingsScm.Y1');
            ...
            utils_1.Logger.Info('getFunctionappSettingsScm.Y2');
