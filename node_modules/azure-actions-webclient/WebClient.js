...
class WebClient {
    ...
    sendRequest(request, options) {
        console.log('WebClient.sendRequest');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                try {
                    ...
                    console.log('WebClient.sendRequest', request);
                    let response = yield this._sendRequestInternal(request);
                    console.log('WebClient.sendRequest.response', response);
                    ...
                    if (retriableErrorCodes.indexOf(error.code) != -1 && ++i < retryCount) {
                        ...
                        console.log('WebClient.sendRequest sleeping', timeToWait);
                        yield this._sleep(timeToWait);
                        timeToWait = timeToWait * retryIntervalInSeconds + retryIntervalInSeconds;
                    }
                    else {
