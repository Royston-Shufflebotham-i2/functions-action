...
class KuduServiceClient {
    ...
    beginRequest(request, reqOptions, contentType) {
        console.log('KSC.beginRequest');

        return __awaiter(this, void 0, void 0, function* () {
            console.log('KSC.beginRequest.awaiter');
            ...
            while (retryCount >= 0) {
                console.log('KSC.beginRequest.awaiter.retryCount', retryCount);

                try {
                    let httpResponse = yield this._webClient.sendRequest(request, reqOptions);
                    console.log('KSC.beginRequest.awaiter. httpResponse', httpResponse);
                    ...
                    console.log('KSC.beginRequest.awaiter.exception', exception);
